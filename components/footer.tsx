    ...
    <div className="relative flex h-full min-h-[292px] flex-col justify-between overflow-hidden bg-[#2d2518] px-4 py-5 text-[#f1eee7] sm:px-6 sm:py-6 lg:min-h-[415px] lg:px-7 lg:py-8">
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className="flex overflow-hidden border border-[#b9a387]/60 bg-[#f0ede5]">
          ...
          />
          <button type="submit" disabled={status === "loading"} className="bg-[#164f3d] px-3 text-[10px] font-medium uppercase tracking-wide text-[#fffaf1] transition-colors hover:bg-[#123b32] disabled:cursor-wait disabled:opacity-60">
        ...
        <p id="new-arrivals-feedback" role="status" className="mt-2 min-h-5 text-xs text-[#d1d2cd]">
          ...
          {status === "success" && <span className="inline-flex items-center gap-1 text-[#174f3d]"><Check className="h-3.5 w-3.5" /> Merci, vous êtes inscrit.</span>}
        </p>
      </form>
    </div>
  )
    ...
    <footer className="w-full overflow-hidden bg-[#ece9e1] text-[#272b2d]">
      <div className="w-full pb-3 pt-0 sm:pb-4 lg:pb-4">
        <div className="grid w-full items-stretch gap-px bg-[#d4d0c6] lg:min-h-[415px] lg:grid-cols-[1.02fr_1.02fr_1fr_1.02fr]">
          <section className="relative hidden min-h-[280px] min-w-0 flex-col items-center justify-center overflow-hidden bg-[#e9e5dc] p-6 sm:p-8 lg:flex lg:min-h-[415px] lg:p-10">
            ...
            <div className="relative z-10 mx-auto max-w-[18rem] text-center text-[#272b2d] drop-shadow-[0_1px_1px_rgba(244,241,233,0.7)]">
              <p className="font-[family-name:var(--font-great-vibes)] text-5xl font-normal leading-none text-[#164f3d] [text-shadow:1px_0_0_#111,-1px_0_0_#111,0_1px_0_#111,0_-1px_0_#111]">Rendi Shop</p>
            </div>
          ...
          <section className="order-1 min-w-0 bg-[#f4f1e9] px-4 py-5 sm:px-8 sm:py-8 lg:order-none lg:px-8 lg:py-9">
            <h3 className="relative mb-3 w-fit text-xs font-semibold uppercase tracking-[0.16em] after:absolute after:-bottom-1 after:left-0 after:h-px after:w-5 after:bg-[#174f3d]">Explorer</h3>
          ...
          <section className="min-w-0 bg-[#f4f1e9] px-6 py-7 sm:px-8 sm:py-8 lg:px-8 lg:py-9">
            <h3 className="relative mb-3 w-fit text-sm font-semibold uppercase tracking-[0.16em] after:absolute after:-bottom-1 after:left-0 after:h-px after:w-5 after:bg-[#174f3d]">Rendi Shop</h3>
            <nav className="flex flex-col">
            ...
            <h3 className="relative mb-3 mt-7 w-fit text-sm font-semibold uppercase tracking-[0.16em] after:absolute after:-bottom-1 after:left-0 after:h-px after:w-5 after:bg-[#174f3d]">Assistance</h3>
            ...
            <div className="mt-6 flex gap-4 text-[#164f3d]">
        ...
        <div className="mx-auto mt-0 flex max-w-5xl flex-col items-center justify-center gap-3 pt-4 text-center text-xs text-[#5c5d5a] sm:flex-row sm:items-center sm:justify-between sm:px-8 sm:text-left">
          ...
          <div className="flex gap-5"><Link href="/terms" className="hover:text-[#164f3d]">Conditions</Link><Link href="/privacy" className="hover:text-[#164f3d]">Confidentialité</Link><Link href="/cookies" className="hover:text-[#164f3d]">Cookies</Link></div>
        </div>
      </div>
    </footer>
  )
