      ...
      <div className="relative w-full h-[520px] md:h-[700px] lg:h-[850px] overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 pb-8 text-center md:px-6 md:pb-0">
          <div className="flex max-w-3xl flex-col items-center">
            <Reveal delay={0}>
              <p className="font-sans text-[5px] font-semibold tracking-[2px] text-[#0f3917] [text-shadow:0_0_0.5px_#fff,0_0_0.5px_#fff] md:text-[13px] md:tracking-[5px]">RENDI SHOP</p>
            </Reveal>
            <Reveal delay={120}>
              <h1 className="mt-1 text-balance leading-none md:mt-[22px]">
                ...
                <span className="relative mt-0 inline-block px-1 pb-4 font-[family-name:var(--font-great-vibes)] text-[clamp(3.35rem,15vw,6.5rem)] font-normal leading-none text-[#0f3917] [text-shadow:0_0_1px_#fff,0_0_1px_#fff] md:mt-2 md:pb-8">
                  espaces modernes
            ...
            <Reveal delay={360}>
              <Link href="/contact" className="mt-5 inline-block md:mt-7">
                <Button className="min-h-11 rounded-[2px] border border-[#8fb8a8] bg-[#111615] px-5 py-3 font-serif text-[10px] font-normal uppercase tracking-[2px] text-white shadow-none hover:bg-[#8fb8a8] hover:text-[#111615] focus-visible:bg-[#8fb8a8] focus-visible:text-[#111615] md:px-8 md:py-[13px] md:text-xs md:tracking-[3px]">
                  Nous contacter
                </Button>
              </Link>
            </Reveal>
